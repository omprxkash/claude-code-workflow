---
name: design-website
description: Generate a premium mockup website for a prospect using a bold editorial-agency template style. Use when user asks to design a website, create a mockup, or build a prospect website.
...
## Goal
Generate a polished, single-page HTML website mockup for a prospect's business. The website matches a bold editorial-agency aesthetic: bold typography, off-white backgrounds, editorial grid layouts, terracotta accents. Used to pitch web design services.
