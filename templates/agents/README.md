...
| `frontend-developer.md` | Frontend specialist for React, Tailwind, state management, accessibility — outputs complete components with usage examples |
| `cli-ui-designer.md` | Terminal/CLI aesthetic UI designer — builds authentic command-line-style web interfaces with full CSS component library |
