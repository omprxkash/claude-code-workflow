# Skills System — CLAUDE.md (26-skill automation architecture)

The fullest example in this collection. Drop into a project root as `CLAUDE.md` for a
complete multi-skill automation system — 26 Skills, 4 subagents, a code-review/QA loop,
Modal webhooks, and the full setup/install steps. Rescued here from a folder that used
to duplicate this content elsewhere in the repo — this is the only copy.
