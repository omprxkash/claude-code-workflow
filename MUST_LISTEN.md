...
| [WAT framework + newsletter build](https://www.youtube.com/watch?v=mpALXah_PBg) | Full title "Build & Sell with Claude Code" — 10+ hours: WAT framework, live newsletter automation build, 5 ways to run Claude Code, plus the business track (selling mindset, pricing, finding/delivering clients) |
