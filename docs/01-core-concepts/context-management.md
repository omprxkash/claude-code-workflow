...
13. **The 5-minute cache rule.** Anthropic's prompt cache has a 5-minute TTL. If you step away longer than 5 minutes, your next message re-processes everything from scratch at full cost. Before stepping away: `/compact` or `/clear`.
